...
public class RegistrationServiceImpl implements RegistrationService{
    ...
    public Boolean checkExistedAccount(RegistrationDto registrationDto) {
        ...
        /* Nếu đăng ký với vai trò tenant thì email không được tồn tại trên bảng Landlord*/
        ...
        /* Nếu đăng ký với vai trò landlord thì email không được tồn tại trên bảng Tenant */
